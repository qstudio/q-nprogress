...
class theme extends \q_nprogress {
  ...
  public static function run()
  {
	...
	public static function wp_enqueue_scripts()
	{
		...
		// helper::log( 'Adding assets...' );

		// add CSS ##
		\wp_register_style( 'q-nprogress', helper::get( 'theme/css/nprogress.css', 'return' ), '', self::version );
		\wp_enqueue_style( 'q-nprogress' );

		// add JS ##
		\wp_enqueue_script( 'q-nprogresss', helper::get( 'theme/javascript/nprogress.js', 'return' ), array( "jquery" ), self::version, false );
